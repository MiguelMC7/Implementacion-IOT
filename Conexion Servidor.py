...
ap.active(True)
ap.config(essid="FAMI MORENO", password="23071714")  # Cambia el SSID y la contraseña
print("Punto de acceso activado. IP:", ap.ifconfig()[0])

# Configurar servidor TCP
server_socket = socket.socket(socket.AF_INET, socket.SOCK_STREAM)
server_socket.bind(('0.0.0.0', 123))  # IP y puerto del servidor
